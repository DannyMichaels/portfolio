...
import { GitHub, Launch, PlayArrow, Code, Web } from '@material-ui/icons';
...
const HologramCard = styled.div`
  ...
  display: flex;
  position: relative;
  animation: ${props => props.isActive ? hologramGlow : 'none'} 4s ease-in-out infinite;
  ...
  &::before {
    ...
    background: linear-gradient(90deg, 
      ...
      transparent 100%);
    animation: ${props => props.isActive ? scanLine : 'none'} 3s linear infinite;
    z-index: 10;
    pointer-events: none;
  }
...
const ProjectImage = styled.div`
  ...
  background: ${props => props.hasImage 
    ...
    : 'linear-gradient(45deg, rgba(0, 255, 255, 0.2) 0%, rgba(102, 126, 234, 0.3) 50%, rgba(240, 147, 251, 0.2) 100%)'
  };
        ...
        return (
          ...
          >
            <HologramCard isActive={isActive}>
              <ImageSection>
                <ProjectImage 
                  hasImage={!!(project?.fields?.img_url || project?.fields?.image)}
                  imageUrl={project?.fields?.img_url || project?.fields?.image || project?.image}
                />
              </ImageSection>
              ...
              <ContentSection>
                <ProjectHeader>
                  <ProjectTitle>
                    {project?.name || project?.fields?.name || `Project_${index + 1}`}
                  </ProjectTitle>
                  <ProjectId>
                ...
                <ProjectDescription>
                  <DescriptionText>
                    {project?.description || project?.fields?.description || 
                ...
                <TechStackSection>
                  ...
                  <TechGrid>
                    {project?.fields?.tech_name1 && <TechChip>{project.fields.tech_name1}</TechChip>}
                    {project?.fields?.tech_name2 && <TechChip>{project.fields.tech_name2}</TechChip>}
                    {project?.fields?.tech_name3 && <TechChip>{project.fields.tech_name3}</TechChip>}
                    {project?.fields?.tech_name4 && <TechChip>{project.fields.tech_name4}</TechChip>}
                  </TechGrid>
                </TechStackSection>
                ...
                <ActionFooter>
                  ...
                  {(project?.fields?.deployed || project?.fields?.website || project?.deployed || project?.website) && (
                    <HologramButton
                      startIcon={<Web />}
                      href={project?.fields?.deployed || project?.fields?.website || project?.deployed || project?.website}
                      target="_blank"
                    >
                      Live Site
                    </HologramButton>
